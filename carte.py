...
class Carte:
    ...
    *quitter_partie: booléen qui permet de signaler la fin d'une partie.
    ...
    def __init__(self, carte_txt):
        """
        On passe la carte en chaine de caractères au constructeur de la classe
        qui la convertie alors en grille d'obstacles et position du robot.
        Le constructeur vérifie aussi que la carte est correcte.
        """
        self.grille = {}
        self.n_lignes = 0
        self.n_cols = 0
